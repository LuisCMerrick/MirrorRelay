export default {
  ...
  strings: {
    ...
    "Passkey authentication is disabled for this instance.": "Passkey authentication is disabled for this instance.",
    "Configure Passkey authentication": "Configure Passkey authentication",
    "Enable Passkey in Settings, restart MirrorRelay, then return here to register a credential.": "Enable Passkey in Settings, restart MirrorRelay, then return here to register a credential.",
    "Ask an administrator to enable Passkey authentication in Settings.": "Ask an administrator to enable Passkey authentication in Settings.",
    ...
    "Use #RGB, #RRGGBB or #RRGGBBAA.": "Use #RGB, #RRGGBB or #RRGGBBAA.",
    "Adaptive Active": "Adaptive Active",
    ...
    "Enable the instance, restart MirrorRelay, then register credentials under My account.": "Enable the instance, restart MirrorRelay, then register credentials under My account.",
    ...
    "Name displayed by the browser or authenticator; maximum 128 bytes.": "Name displayed by the browser or authenticator; maximum 128 bytes.",
    "Leave blank to use the administration request host. Otherwise enter a lowercase hostname or IP without a scheme, port or path.": "Leave blank to use the administration request host. Otherwise enter a lowercase hostname or IP without a scheme, port or path.",
    "Leave blank to use the current request origin. Otherwise enter one HTTPS origin per line; HTTP is allowed only for loopback development.": "Leave blank to use the current request origin. Otherwise enter one HTTPS origin per line; HTTP is allowed only for loopback development.",
